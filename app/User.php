...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'number_identification', 'email', 'password', 'phone', 'api_token', 'birth_date', 'working', 'lat', 'lng', 'numorders', 'rejectedorders','restaurant_id','expotoken', 'changed_password',
    ];
