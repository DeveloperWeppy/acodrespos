    ...
    'env'=>[
        [
            ...
            'fields'=>[
                ...
                ['title'=>'Subdomains', 'key'=>'IGNORE_SUBDOMAINS', 'value'=>'www,127', 'help'=>'Subdominio en el que funciona su aplicación. Por ejemplo, si su subdominio es app.yourdomain.com, aquí debería tener www,app '],
                ['title'=>'App debugging', 'key'=>'APP_DEBUG', 'value'=>'true', 'ftype'=>'bool', 'help'=>'Habilitar si experimenta el error 500'],
                ...
                ['title'=>'Plantilla de front-end', 'key'=>'FRONT_END_TEMPLATE', 'value'=>'defaulttemplate', 'ftype'=>'select', 'data'=>[]],
                ...
                ['title'=>'Permitir al vendedor hacer su propia entrega', 'key'=>'APP_ALLOW_SELF_DELIVER', 'value'=>'true', 'ftype'=>'bool', 'onlyin'=>'ft'],
                ['title'=>'Time for order to be prepared', 'help'=>'Se prepara el pedido en un tiempo promedio, por lo que los usuarios no pueden ordenar antes de que el proveedor o la tienda cierren', 'key'=>'TIME_TO_PREPARE_ORDER_IN_MINUTES', 'value'=>0, 'type'=>'hidden', 'onlyin'=>'ft'],
                ['title'=>'Radio de búsqueda de proveedores', 'help'=>'Distancia máxima que se muestran los proveedores al usuario', 'key'=>'LOCATION_SEARCH_RADIUS', 'value'=>50, 'type'=>'number', 'onlyin'=>'ft'],
                ...
                ['title'=>'Delivery / time intervals in minutes', 'help'=>'Separe los intervalos de tiempo en N Minutos. ejem 09:00-09:15, 09:15-09:30 - el valor es 15 ', 'key'=>'DELIVERY_INTERVAL_IN_MINUTES', 'value'=>30, 'type'=>'number'],
                ...
                ['title'=>'Is your project multi city', 'help'=>'Cuando se selecciona, la página principal mostrará una lista de ciudades', 'key'=>'MULTI_CITY', 'value'=>'true', 'ftype'=>'bool', 'onlyin'=>'ft'],
                ['title'=>'Modo único: ejecute este sitio solo para un proveedor', 'key'=>'SINGLE_MODE', 'value'=>'false', 'ftype'=>'bool', 'onlyin'=>'ft'],
                ['title'=>'La identificación del proveedor para el modo único', 'help'=>'Si ha seleccionado el modo único, se mostrará esta identificación de proveedor', 'key'=>'SINGLE_MODE_ID', 'value'=>'1', 'type'=>'number', 'onlyin'=>'ft'],
                ['title'=>'Habilitar la importación a través de CSV para artículos de proveedores', 'key'=>'ENABLE_IMPORT_CSV', 'value'=>'false', 'ftype'=>'bool'],
                ['title'=>'Enviar notificación de pedido por correo electrónico en el correo electrónico del proveedor (se puede configurar por proveedor a través de aplicaciones)', 'key'=>'ENABLE_SEND_ORDER_MAIL_TO_VENDOR', 'value'=>'false', 'ftype'=>'bool'],  
                ...
                ['title'=>'Enable cost based on range', 'help'=>'Si ha habilitado el costo basado en el rango, el costo de entrega se calculará según el rango en el que se encuentra la distancia de entrega', 'key'=>'ENABLE_COST_IN_RANGE', 'value'=>'false', 'ftype'=>'bool', 'onlyin'=>'ft'],
                ...
                ['title'=>'Nombre de la entidad del proveedor', 'help'=>'Ejem. Empresa, restaurante, tienda, negocio, etc.', 'key'=>'VENDOR_ENTITY_NAME', 'value'=>'Restaurant'],
                ['title'=>'Nombre de la entidad proveedora en plural', 'help'=>'Ejem. Empresas, Restaurantes, Tiendas, Negocios, etc.', 'key'=>'VENDOR_ENTITY_NAME_PLURAL', 'value'=>'Restaurants'],
                ['title'=>'Ruta de URL para el proveedor', 'help'=>'If you want to change the link the vendor is open in. ex yourdomain.com/shop/shopname. shop - should be the value here', 'key'=>'URL_ROUTE', 'value'=>'restaurant'],
                ['title'=>'Ruta de URL para el proveedor en plural', 'help'=>'If you want to change the link the vendor management is open in. ex yourdomain.com/shops. shops - should be the value here', 'key'=>'URL_ROUTE_PLURAL', 'value'=>'restaurants'],
                ['title'=>'código de descarga de aplicaciones', 'help'=>'Si tiene una licencia extendida o algún producto específico, le enviaremos el código de descarga de la aplicación. Envíanos boleto.', 'key'=>'EXTENDED_LICENSE_DOWNLOAD_CODE', 'value'=>''], 
                ...
                ['title'=>'Caracteres en la lista del menú', 'key'=>'CHARS_IN_MENU_LIST', 'value'=>'40', 'type'=>"number", 'help'=>'Controla cuántos caracteres debe recortarse la descripción del menú'],
                ...
                ['title'=>'Posición para el enlace de registro de proveedores', 'key'=>'RESTAURANT_LINK_REGISTER_POSITION', 'value'=>'footer', 'data'=>['footer'=>'Footer', 'navbar'=>'Navigation bar', 'dontshow'=>'Hidden'], 'ftype'=>'select', 'onlyin'=>'ft'],

                ['title'=>'Title of driver link', 'key'=>'DRIVER_LINK_REGISTER_TITLE', 'value'=>'Wanna drive for us?', 'onlyin'=>'ft'],
                ['title'=>'Título para el enlace de registro de proveedores', 'key'=>'RESTAURANT_LINK_REGISTER_TITLE', 'value'=>'Add your vendor', 'onlyin'=>'ft'],

                ['title'=>'Mobile app secret', 'key'=>'APP_SECRET', 'value'=>'APP_SECRET'],
                ['title'=>'Unidad','ftype'=>'select', 'key'=>'UNIT', 'value'=>'K','data'=>['k'=>'Kilometros', 'Mi'=>'Millas'] ],
