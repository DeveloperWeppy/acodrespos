...
@endisset
    ...
    <select @isset($disabled) {{ "disabled" }} @endisset  class="form-control form-control   @isset($classselect) {{$classselect}} @endisset"  name="{{ $id }}" id="{{  $id }}" <?php if($required) {echo 'required';} ?> >
