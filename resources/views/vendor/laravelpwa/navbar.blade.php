  ...
  <div class="container">
    <a class="navbar-brand m-0" >
      @if(!config('settings.hide_project_branding'))
        <!-- Restaruant Branding -->
        <img src="" class="navbar-brand-img h-80 w-30" alt="...">
      @else
        <!-- Admin branding -->
      ...
      <ul class="navbar-nav navbar-nav-hover ms-auto">
        <div class="row" style="display: contents;">
          ...
          <div class="col-auto m-auto">
            ...
            <div class="dropdown" >
              <a class="text-white cursor-pointer" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">ddd</a>
