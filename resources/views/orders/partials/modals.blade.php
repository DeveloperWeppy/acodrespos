...
<div class="modal fade" id="modal-partials-time" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="modal-title-new-item">Aumentar tiempo de entrega</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body p-0">
                <div class="card bg-secondary shadow border-0">
                    ...
                    <form role="form" method="POST" id="form-set_qty" action="{{ route('orders.update',['order'=>isset($order)?$order->id:1]) }}">
                        ...
                        @method('PATCH')
                        <div class="form-group">
                        <label class="form-control-label" for="item_qty">Minutos que desea aumenta</label>
                            <input min="0" class="form-control form-control " type="number" name="delivery_pickup_interval" id="delivery_pickup_interval"/>
