                        ...
                        <div class="info-block block-info clearfix" v-cloak>
                            ...
                            <div class="d-flex">
                                <p class="product-item_quantity">@{{ item.quantity }} x 
                                    <div class="pl-2">
                                        <div class="product-item_quantity" >@{{ item.attributes.friendly_price }}</div>
                                        <div class="product-item_quantity text-danger" style="text-decoration: line-through;white-space: nowrap;" v-if="item.attributes.friendly_price!=item.attributes.discount">@{{ item.attributes.discount  }}</div>
                                    </div>
                                </p>
                            </div>
                            <div class="row">
