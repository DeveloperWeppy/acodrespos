...
<div class="modal  fade " id="modalMesaReservada" tabindex="-1" role="dialog" aria-labelledby="modal-default"
    ...
    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <p>La mesa ha sido reservada por el cliente ######### identificado con ID ############</p>
                    <p>Hora de reserva ############</p>

                    <br>
                    <p>Si el cliente no llega en los siguentes ## minutos, la mesa se desocupara automaticamente.</p>
                </div>
            </div>
            <div class="modal-footer">
                <button id="" class="btn bg-gradient-primary">Confirmar ocupacion de mesa</button>
            </div>
        </div>
    </div>
</div>
